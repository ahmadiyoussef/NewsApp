...
class BreakingNewsFragment: Fragment(R.layout.fragment_breaking_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.breakingNews.observe(viewLifecycleOwner, Observer { response->
           when(response){
                  is com.androiddevs.mvvmnewsapp.ui.util.Resource.Success->{
                      hideProgressBar()
                  ...
                  is com.androiddevs.mvvmnewsapp.ui.util.Resource.Error->{
                      hideProgressBar()
                      Toast.makeText(activity, " An error occured :${response.message}", Toast.LENGTH_LONG)
                          .show()
                  }

                  is com.androiddevs.mvvmnewsapp.ui.util.Resource.Loading->{
                      showProgressBar()
                  }
           }
        } )
